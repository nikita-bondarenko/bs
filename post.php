...
$mess3 = _cleardigit(substr(htmlspecialchars(trim($_POST['phone']),ENT_QUOTES, 'utf-8'), 0, 2000)); //type
$mess4 = _cleardigit(substr(htmlspecialchars(trim($_POST['comment']),ENT_QUOTES, 'utf-8'), 0, 2000)); //type
